...
public static class ObjectPoolCreator
{
	...
	public static void CreateScript()
	{
		...
		foreach (var guid in AssetDatabase.FindAssets("t:Script"))
		{
			...
			var poolObject = (pathObject as MonoScript);
			Debug.Log(poolObject);

			MonoScript mono = AssetDatabase.LoadAssetAtPath("Assets/AssetStoreTools/unknown.png", typeof(PoolObjectBase)) as MonoScript;
            ...
            //if (pathObject.GetType().IsGetBaseTypes(typeof(PoolObjectBase)))
            //{
            //    builder
            //        .Append("\t")
            //        .AppendFormat
